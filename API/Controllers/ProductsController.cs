...
namespace API.Controllers
{
    public class ProductsController : BaseApiController
    {
        ...
        [HttpPost]
        public async Task<ActionResult<Product>> CreateProduct([FromForm] CreateProductsDto productDto)
        {
        ...
        {
            var product = await _context.Products.Where(x => x.Id == productDto.Id).FirstOrDefaultAsync();
